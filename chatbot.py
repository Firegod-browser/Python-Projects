...
def chatbot():
    ...
    print("\033[1;31mBot: Hi! I'm a simple chatbot. Type 'bye' to exit.")
    print('\033[1;31mHere are My inputs:')
    print('\033[1;31m---------------------------------------------------------------------------------------------')
    print('\033[1;36mHi: for asking hi')
    print('\033[1;36mHow are you doing: for asking how are you doing')
    print('\033[1;36mcreator : for the name made in turtle of the creator of this project')
    print('\033[1;36mname: for its name')
    print('\033[1;36mcalc: to open a calculator')
    print('\033[1;36mjoke: for a good joke')
    print('\033[1;36mgame: for a simple rock-paper-scissors best out of 10')
    print('\033[1;36mbuilt: for when this was built and what this runs on')
    print('\033[1;36mroll: for a dice rolling game against some one else')
    print('\033[1;36macronym: to search a acronym dictionary for computer science acronyms')
    print('\033[1;36mdivisible: for a divisibility calculater')
    print('\033[1;36mcoin: for a coin flip simulator with a fair coin')
    print('\033[1;36mquiz: for a 5 question math quiz')
    print('\033[1;36mttt: to play tic-tac-toe against another person')
